    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('pub_date', models.DateTimeField(default=core.models.local_now, verbose_name='登録日')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('description', models.TextField(default='これがカテゴリの説明文です。', verbose_name='カテゴリの説明文')),
                ('upper', models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.CASCADE, related_name='lowers', to='core.category', verbose_name='上位カテゴリ')),
            ],
        ),
        migrations.CreateModel(
            name='Article',
            fields=[
                ...
                ('pub_date', models.DateTimeField(default=core.models.local_now, verbose_name='投稿日')),
                ('renew_date', models.DateTimeField(default=core.models.local_now, verbose_name='更新日')),
                ('title', models.CharField(max_length=200, verbose_name='タイトル')),
                ('view_count', models.IntegerField(default=0, verbose_name='PV数')),
                ('second_content', django_editorjs_fields.fields.EditorJsJSONField()),
                ('second_content_text', django_editorjs_fields.fields.EditorJsTextField()),
